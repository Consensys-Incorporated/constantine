...
pub const CTT_FIELD_ELEMENTS_PER_CELL: u32 = 64;
pub const CTT_CELLS_PER_EXT_BLOB: u32 = 128;
pub const CTT_BYTES_PER_CELL: u32 = 2048;
pub const CTT_CELLS_PER_BLOB: u32 = 64;
...
#[repr(align(64))]
#[derive(Copy, Clone)]
pub struct ctt_keccak256_context {
    state: [u64; 25usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ctt_keccak256_context"][::core::mem::size_of::<ctt_keccak256_context>() - 256usize];
    ["Alignment of ctt_keccak256_context"]
        [::core::mem::align_of::<ctt_keccak256_context>() - 64usize];
    ["Offset of field: ctt_keccak256_context::state"]
        [::core::mem::offset_of!(ctt_keccak256_context, state) - 0usize];
};
unsafe extern "C" {
    #[doc = " Initialize or reinitialize a Keccak256 context."]
    pub fn ctt_keccak256_init(ctx: *mut ctt_keccak256_context);
}
unsafe extern "C" {
    #[doc = " Append a message to a Keccak256 context\n  for incremental Keccak256 computation\n\n  Security note: the tail of your message might be stored\n  in an internal buffer.\n  if sensitive content is used, ensure that\n  `ctx.finish(...)` and `ctx.clear()` are called as soon as possible.\n  Additionally ensure that the message(s) passed were stored\n  in memory considered secure for your threat model.\n\n  For passwords and secret keys, you MUST NOT use raw Keccak256\n  use a Key Derivation Function instead (KDF)"]
    pub fn ctt_keccak256_update(
        ctx: *mut ctt_keccak256_context,
        message: *const byte,
        message_len: usize,
    );
}
unsafe extern "C" {
    #[doc = " Finalize a Keccak256 computation and output the\n  message digest to the `digest` buffer.\n\n  Security note: this does not clear the internal buffer.\n  if sensitive content is used, use \"ctx.clear()\"\n  and also make sure that the message(s) passed were stored\n  in memory considered secure for your threat model.\n\n  For passwords and secret keys, you MUST NOT use raw Keccak256\n  use a Key Derivation Function instead (KDF)"]
    pub fn ctt_keccak256_finish(ctx: *mut ctt_keccak256_context, digest: *mut byte);
}
unsafe extern "C" {
    #[doc = " Clear the context internal buffers\n  Security note:\n  For passwords and secret keys, you MUST NOT use raw Keccak256\n  use a Key Derivation Function instead (KDF)"]
    pub fn ctt_keccak256_clear(ctx: *mut ctt_keccak256_context);
}
unsafe extern "C" {
    #[doc = " Compute the Keccak256 hash of message\n  and store the result in digest.\n  Optionally, clear the memory buffer used."]
    pub fn ctt_keccak256_hash(
        digest: *mut byte,
        message: *const byte,
        message_len: usize,
        clear_memory: bool,
...
const _: () = {
    ...
    ["Alignment of big381"][::core::mem::align_of::<big381>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of big255"][::core::mem::align_of::<big255>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of big254"][::core::mem::align_of::<big254>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of big253"][::core::mem::align_of::<big253>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_fr"][::core::mem::align_of::<bls12_381_fr>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_fp"][::core::mem::align_of::<bls12_381_fp>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_fp2"][::core::mem::align_of::<bls12_381_fp2>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_g1_aff"][::core::mem::align_of::<bls12_381_g1_aff>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_g1_jac"][::core::mem::align_of::<bls12_381_g1_jac>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_g1_prj"][::core::mem::align_of::<bls12_381_g1_prj>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_g2_aff"][::core::mem::align_of::<bls12_381_g2_aff>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_g2_jac"][::core::mem::align_of::<bls12_381_g2_jac>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bls12_381_g2_prj"][::core::mem::align_of::<bls12_381_g2_prj>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_fr"][::core::mem::align_of::<bn254_snarks_fr>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_fp"][::core::mem::align_of::<bn254_snarks_fp>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_fp2"][::core::mem::align_of::<bn254_snarks_fp2>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_g1_aff"][::core::mem::align_of::<bn254_snarks_g1_aff>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_g1_jac"][::core::mem::align_of::<bn254_snarks_g1_jac>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_g1_prj"][::core::mem::align_of::<bn254_snarks_g1_prj>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_g2_aff"][::core::mem::align_of::<bn254_snarks_g2_aff>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_g2_jac"][::core::mem::align_of::<bn254_snarks_g2_jac>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of bn254_snarks_g2_prj"][::core::mem::align_of::<bn254_snarks_g2_prj>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of pallas_fr"][::core::mem::align_of::<pallas_fr>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of pallas_fp"][::core::mem::align_of::<pallas_fp>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of pallas_ec_aff"][::core::mem::align_of::<pallas_ec_aff>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of pallas_ec_jac"][::core::mem::align_of::<pallas_ec_jac>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of pallas_ec_prj"][::core::mem::align_of::<pallas_ec_prj>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of vesta_fr"][::core::mem::align_of::<vesta_fr>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of vesta_fp"][::core::mem::align_of::<vesta_fp>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of vesta_ec_aff"][::core::mem::align_of::<vesta_ec_aff>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of vesta_ec_jac"][::core::mem::align_of::<vesta_ec_jac>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of vesta_ec_prj"][::core::mem::align_of::<vesta_ec_prj>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of banderwagon_fr"][::core::mem::align_of::<banderwagon_fr>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of banderwagon_fp"][::core::mem::align_of::<banderwagon_fp>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of banderwagon_ec_aff"][::core::mem::align_of::<banderwagon_ec_aff>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of banderwagon_ec_jac"][::core::mem::align_of::<banderwagon_ec_jac>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of banderwagon_ec_prj"][::core::mem::align_of::<banderwagon_ec_prj>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ctt_span"][::core::mem::size_of::<ctt_span>() - 8usize];
    ["Alignment of ctt_span"][::core::mem::align_of::<ctt_span>() - 4usize];
